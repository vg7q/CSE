...
church = Room("chruch", CHURCH, '', 'choices', 'jump', '', '', '', '', '')
...
quiz_or_fizz = Room("quizz or fizz 1", QUIZ_OR_FIZZ_1, '', 'Quiz_or_fizz_2', 'Silent_room', '', '', '', '', '')
quizz_for_fizz = Room("quizz or fizz 2", QUIZ_OR_FIZZ_2, '', '', 'minions', '', '', '', '', '',)
minions = Room("minions", MIONIONS, 'quiz_or_fiz_2', '', 'boss', '', '', '', '', '')
boss = Room("boss", BOSS, 'minions', '', '', '', '', '', '', '')
box_choice_1 = Room("box choice 1", BOX_CHOICES_1, '', '', '', '', 'choices', '', '', '')
box_choice_2 = Room('box choice 2', BOX_CHOICES_2, '', '', '', 'choices', '', '', '', '')
box_choice_3 = Room('box choice 3', BOX_CHOICES_3, '', '', '', '', '', '', 'choices', '')
